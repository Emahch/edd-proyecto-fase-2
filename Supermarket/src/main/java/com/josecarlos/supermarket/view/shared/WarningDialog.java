 ...
 */
package com.josecarlos.supermarket.view.shared;
...
public class WarningDialog extends javax.swing.JDialog {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(WarningDialog.class.getName());
     ...
     */
    public WarningDialog(java.awt.Frame parent, boolean modal, String title, String text) {
